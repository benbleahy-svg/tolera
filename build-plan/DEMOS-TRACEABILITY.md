...
- **Screenshots:** [`DemoA/`](../docs/reference/screenshots/DemoA/) (dashboard, quote detail, BOM builder, sheet-metal interrogation, PDF+AI review, multi-qty pricing, nesting config/overview, bulk-edit, costing summary, quote general).
...
- **Screenshots:** [`DemoC/`](../docs/reference/screenshots/DemoC/) (part setup, print viewer + extractions, callout popover, whiteout, add-missing modal, create-rule empty/filled, resolution dropdown, signal tree, line-item review panel, quote-level summary).
...
- **Screenshots:** [`DemoD/`](../docs/reference/screenshots/DemoD/) (assembly drawing, actions dropdown, split toasts, files after split, BOM builder loaded/add-files/subassemblies, complete 43 parts, published BOM line item).
...
- **Screenshots:** [`DemoE/`](../docs/reference/screenshots/DemoE/) (pricing-today slide, custom-markups overview, P3L how-it-works, demo quote, examples 1–6 costing/pricing, configure pricing/processes).
...
- **Screenshots:** [`DemoF/`](../docs/reference/screenshots/DemoF/).
...
- **Screenshots:** [`DemoG/`](../docs/reference/screenshots/DemoG/).
...
- **Screenshots:** [`DemoH/`](../docs/reference/screenshots/DemoH/).
...
- **Screenshots:** [`DemoI/`](../docs/reference/screenshots/DemoI/).
...
- **Blocks:** M4.3 (nesting).
- **Screenshots:** [`DemoJ/`](../docs/reference/screenshots/DemoJ/).
...
- **Screenshots:** [`DemoK/`](../docs/reference/screenshots/DemoK/).
...
- **Screenshots:** [`DemoL/`](../docs/reference/screenshots/DemoL/).
...
- **Screenshots:** [`DemoM/`](../docs/reference/screenshots/DemoM/).
...
- **Screenshots:** [`DemoN/`](../docs/reference/screenshots/DemoN/) (milling/lathe/sheet-metal/wire-EDM/additive/waterjet-laser feature + warning frames).
...
- **Screenshots:** [`DemoO/`](../docs/reference/screenshots/DemoO/).
